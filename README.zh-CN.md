...
<picture>
  ...
  <img src="docs/screenshots/hero-light.png" alt="联通套餐查询 —— 套餐余量按到期时间分组，哪块月底作废一眼看得见" width="880" />
</picture>
...
用联通号码登录后，面板展示套餐里真正还剩多少。内容拆成四个页面，每个都有自己的地址 —— `lg:` 起靠 264px 的侧栏切换，以下换成底部标签栏：
